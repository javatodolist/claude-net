...
export default withMermaid(
  defineConfig({
    lang: 'zh-CN',
    title: 'Claude中文网 | Claude国内使用、Claude Code与API教程',
    ...
    head: [
      ...
      ['meta', { name: 'keywords', content: 'Claude国内使用,Claude中文网,Claude Code国内安装,Claude API接入,Claude订阅付款,Claude封号,Claude提示词,AI编程' }],
      ['meta', { name: 'author', content: 'Claude中文网' }],
      ...
      // 百度站长平台自动推送：页面加载时把当前 URL 推送给百度收录
      ['script', {},
        `(function() {
      ...
      ['noscript', {}, '<link rel="stylesheet" href="//at.alicdn.com/t/font_3180624_7cy10l7jqqh.css">'],
    ...
    sitemap: {
      ...
      transformItems: (items) => {
        ...
        return items.map((item) => {
          ...
          if (LOW_PRIORITY_DIRS.some((dir) => url.startsWith(dir))) {
