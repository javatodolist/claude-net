---
title: IDEA不只接Claude和Codex 本地模型和第三方API也能直接用
description: IDEA不只接Claude和Codex 本地模型和第三方API也能直接用。本文属于Claude API 接入与开发专题，面向国内用户梳理 Claude 使用、Claude Code 编程和 AI 开发实践。
date: 2026-05-25
...
# IDEA不只接Claude和Codex 本地模型和第三方API也能直接用

![Banner](/assets/images/localized/segmentfault.com-4cea40612b5e.png)
...
![AI Assistant Agents](/assets/images/localized/segmentfault.com-1be075450fdd.png)

在这个界面里，可以扫描并安装自己想用的 AI 编程助手插件。

安装完成后，打开 AI Chat 面板，选择对应 Agent 即可。

![选择 Agent](/assets/images/localized/segmentfault.com-2f7e0ae61f9d.png)
...
![Providers & API keys](/assets/images/localized/segmentfault.com-31328b427672.png)
...
![OpenAI 兼容接口配置](/assets/images/localized/segmentfault.com-0baa01aa2949.png)
...
![Ollama 本地模型配置](/assets/images/localized/segmentfault.com-b4b45399f027.png)
...
![选择 Chat 模式](/assets/images/localized/segmentfault.com-5bd0cf5a5c67.png)

然后在右下角选择 API 提供商对应的模型。

![选择 API 模型](/assets/images/localized/segmentfault.com-f62f865a0b01.png)

测试一下输出效果。

![API 调用测试](/assets/images/localized/segmentfault.com-7facf7850d04.png)
