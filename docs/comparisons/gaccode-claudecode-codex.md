---
title: 保姆级教程，通过GACCode在国内使用Claudecode、Codex！
description: 保姆级教程，通过GACCode在国内使用Claudecode、Codex！。本文属于Claude 对比评测专题，面向国内用户梳理 Claude 使用、Claude Code 编程和 AI 开发实践。
date: 2026-05-05
...
![Banner](/assets/images/localized/developer.qcloudimg.com-9bd9285080c2.png)
...
![方案概览](/assets/images/localized/ucc.alicdn.com-b207ff8bf638.png)
...
![Claude Code 配置国产模型](/assets/images/localized/ucc.alicdn.com-cd559870bfbb.png)
...
![官方原版 + API](/assets/images/localized/ucc.alicdn.com-cd559870bfbb.png)
...
![Codex 安装与配置](/assets/images/localized/ucc.alicdn.com-c0e450fbeacf.png)
...
![Gemini CLI 使用](/assets/images/localized/ucc.alicdn.com-4327d6bbf4a5.png)
