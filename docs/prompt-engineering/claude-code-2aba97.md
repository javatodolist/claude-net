...
这些方法的前提，是你手头得有个能稳定跑的 Claude Code。国内用户不想折腾海外信用卡和网络，可以通过 [Code80](https://code.ai80.vip/home) 直接用 Claude API，真实订阅帐号转出来的，和官方完全兼容，换个 endpoint 就能接进 Claude Code，支持国内支付。详情 [code.ai80.vip](https://code.ai80.vip/home)。
相关阅读：
